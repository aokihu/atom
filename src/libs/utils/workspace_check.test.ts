...
describe("workspace_check", () => {
  test("creates missing AGENT.md, config files, memory and secrets", async () => {
    ...
    expect(await Bun.file(join(workspace, "message_gateway.config.json")).exists()).toBe(true);
